...
void suite("multipart encoding", () => {
  ...
  void test("encodes form-data", () => {
    ...
    const result = template.transform({}) as Payload<Uint8Array>;
  ...
  void test("encodes evaluated directives", () => {
    const template = Template.parse(
      {
        $encode: "multipart",
        user: {
    ...
    const result = template.transform({
      name: "John Doe",
  ...
  void test("encodes nested multipart data", () => {
    const template = Template.parse(
      {
        $encode: "multipart",
        $subtype: "form-data",
  ...
  void test("encodes custom headers and dispositions", () => {
    const template = Template.parse(
      {
        $encode: "multipart",
        file: {
  ...
  void test("encodes default content types", () => {
    const template = Template.parse(
      {
        $encode: "multipart",
        string: "plain text",
  ...
  void test("supports explicit headers", () => {
    const template = Template.parse(
      {
        $encode: "multipart",
        $headers: {
  ...
  void test("supports binary data", () => {
  ...
  void test("supports binary data in $content", () => {
    const binaryData = new Uint8Array([0x00, 0x01, 0x02, 0x03]);
    const template = Template.parse(
      {
        $encode: "multipart",
  ...
  void test("supports binary data in $content with domain properties", () => {
    const binaryData = new Uint8Array([0x00, 0x01, 0x02, 0x03]);
    const template = Template.parse(
      {
        $encode: "multipart",
