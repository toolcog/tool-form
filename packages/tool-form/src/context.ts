 ...
 * @category Context
 */
export interface FormContext extends QueryContext {
  /**
 ...
 * @category Context
 */
export interface FormContextOptions extends QueryContextOptions {
  /**
...
export function initFormContext(
  context: QueryContext & Partial<FormContext>,
...
export function createFormContext(options?: FormContextOptions): FormContext {
  return initFormContext(createQueryContext(options), options);
}
