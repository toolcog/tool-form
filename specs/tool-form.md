...
5. [Operator Directives](#5-operator-directives)  
   ...
   5.2. [`$transform` Directive](#52-transform-directive)  
   5.3. [`$encode` Directive](#53-encode-directive)
...
Value Type: string  
Domain Properties: $items (array, optional)  
Reference: Section 5.1 of this document

Name: $encode
Category: Operator
Description: Controls output encoding
Value Type: string
Domain Properties: $content (any)
